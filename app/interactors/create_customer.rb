...
module Interactor
  class CreateCustomer < Base
    ...
    def run
      customer = Customer.new forename: request.forename, surname: request.surname, prefix: request.prefix, telephone_number: request.telephone_number, note: request.note, date_of_birth: request.date_of_birth
