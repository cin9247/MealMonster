...
ManageTourWidget = React.createClass
  ...
  render: ->
    React.DOM.div(null, [
      CareEAR.SearchableCustomerBox({customers: @state.customers, customerTableView: CustomerTable, tableWidth: 9, searchAttributes: ["full_name"], addToTourHandler: @addToTourHandler, tourCount: @state.tours.length})
